...
PS_OUT		PS_MAIN_POINT(PS_IN In)
{
	...
	vector		vPosition = tex2D(PositionSampler, In.vTexUV);;
	...
	Out.vSpecular = (pow(saturate(dot(vReflect, vLook)), g_fPower)) * fAtt * 0.2f;
	//Out.vSpecular.a = 0.1f;
