...
HRESULT CDynamicCamera::LateReady_GameObject()
{
	Engine::CTransform* pPlayerTrasnform = dynamic_cast<Engine::CTransform*>(Engine::Get_Component(
		L"02.GameLogic", L"Dyn_Player", L"Com_Transform", Engine::ID_DYNAMIC));
