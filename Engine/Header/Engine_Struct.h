...
namespace Engine
{
	...
	const _ulong		FVF_TEX_COL = D3DFVF_XYZ  | D3DFVF_TEX1;
	...
	typedef struct D3DXMESHCONTAINER_DERIVED : public D3DXMESHCONTAINER
	{
		...
		_matrix**				ppFrameCombinedMatrix;		// 뼈들이 갖고 있는 CombinedTransformationMatrix의 주소값을 보관하기 위한 이중 포인터
		//(매 프레임마다 갱신을 해야하기 때문에 매번 갱신 시점마다 행렬을 얻어오는 행위는 비 합리적이다. 그래서 한꺼번에 보관하려 하는 것이다.)
