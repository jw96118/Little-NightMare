...
HRESULT		Ready_Buffer(LPDIRECT3DDEVICE9 pGraphicDev,
						...
						const _ulong dwCntX,
						const _ulong dwCntZ,
						const _ulong dwVtxItv,  _vec3 vStartPos)
{
	return CResourcesMgr::GetInstance()->Ready_Buffer(pGraphicDev, wContainerIdx, pBufferTag, eID, dwCntX, dwCntZ, dwVtxItv, vStartPos);
}
